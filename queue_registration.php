                    ...
                    <div class="col-md-7">
                        ...
                        <div class="card rouded-0 shadow">
                            ...
                            <div class="card-header rounded-0">
                                <div class="h5 card-title">LIVE (For Medicine, Basic Ed programs)</div>
                            </div>
                            <div class="card-body rounded-0">
                                <form action="" id="queuelive-form">
                                    <div class="form-group">
                                        <label for="customer_name" class="control-label text-info">Enter your Name</label>
                                        <input type="text" id="customer_namel" name="customer_name" autofocus autocomplete="off" type="submit" <?php echo $buttonDisabled; ?> class="form-control form-control-lg rounded-0 border-0 border-bottom" required>
                                    </div>                                
