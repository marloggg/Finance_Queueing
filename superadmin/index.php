        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'students')? 'active' : '' ?>"aria-current="page"href="./?page=students">Student List</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'guests')? 'active' : '' ?>"aria-current="page" href="./?page=guests">Guest List</a>
                    </li>
                    <li class="nav-item">
