            ...
            <div class="card-body">
                ...
                <form action="" id="login-form">
                    ...
                    <div class="form-group">
                        <label for="teller_id" class="control-label">Teller Number</label>
                        <select name="teller_id" id="teller_id" data-placeholder="Please Select Teller to Operate" class="custom-select2 select2">
